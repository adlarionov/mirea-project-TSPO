...
export default function Feedback() {
  return (
    <div className="px-4 lg:px-24 mb-20">
      <div className="mb-4 lg:mb-10">
        <h1
          className={classNames(micra.className, "text-[22px] md:text-[32px]")}
        >
      ...
      >
        <CarouselContent>
          <CarouselItem key={0} className="md:basis-1/3">
            <Comment
              key={0}
          ...
          <CarouselItem key={1} className="md:basis-1/3">
            <Comment
              key={1}
